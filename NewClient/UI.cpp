...
bool UI::Init()
{
	...
	m_vUIList.push_back(PlayerState);
	...
	m_vUIList.push_back(BossPortrait);
	...
	m_vUIList.push_back(BossState1);
	...
	m_vUIList.push_back(BossState2);
	...
	m_vUIList.push_back(BossState3);
...
bool UI::Frame()
{
	...
	{
		for (int i = UI_DESC::BOSS_STATE; i <= UI_DESC::BOSS_HP3; ++i)
		{
